...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_krl to login script."
...
# the current dir:
if   test x${GTLANG_krl} = x ; then
	echo "WARNING: The variable \${GTLANG_krl} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_krl} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_krl} has the value:"
	echo "  ${GTLANG_krl}"
